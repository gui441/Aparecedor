                ...
                children: [
                  new TableCell({
                    ...
                    children: [
                      ...
                      new Paragraph({ children: [new TextRun("04. Nota de Empenho n.º "), new TextRun({ text: "{num_empenho}", bold: true }), new TextRun(";")], spacing: { line: 360 } }),
                      new Paragraph({ children: [new TextRun("05. Nota de Liquidação n.º "), new TextRun({ text: "{num_liquidacao}", bold: true }), new TextRun(";")], spacing: { line: 360 } }),
